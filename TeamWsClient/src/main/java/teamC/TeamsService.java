 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://TeamWsServer.ws.training/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://TeamWsServer.ws.training/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://TeamWsServer.ws.training/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://TeamWsServer.ws.training/", "TeamsPort"), Teams.class, features);
    }
